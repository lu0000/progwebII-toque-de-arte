...
<body>
    ...
    <main><!--Corpo do Site-->
    <section class="secao">
            <h1 class="titulo-paginas">Produtos da categoria Bolsas / Chapeus:</h1>
            <div class="pro1">
                <?php
                    foreach($produtos_bolsa as $i => $f){
                ?>                     
                <div class="pro2">
                    <a class="proaa" href="comprarbolsas.php?i=<?=$i?>">
                        <div class="pro3">
